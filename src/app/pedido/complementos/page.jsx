...
import { ArrowLeft, Minus, Plus, ShoppingBag, Utensils } from 'lucide-react';
import toast from 'react-hot-toast';

import { useLoja } from '@/hooks/useLoja.js';
import { useProdutosCardapio } from '@/hooks/useProdutosCardapio.js';
...
export default function ComplementosPedido() {
    ...
    if (statusLoja !== true || carrinho.length === 0) {
        return null;
    }
