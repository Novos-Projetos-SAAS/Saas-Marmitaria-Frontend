...
import { alterarCategoriaProduto, buscarCategoriaProdutoPorId } from "@/services/categoriasProdutosService.js";
                    ...
                    onSave={async (payload) => {
                        try {
                            ...
                            await Swal.fire({
                                icon: "error",
                                title: "Erro",
                                text: error?.response?.data?.message || "Falha ao atualizar a categoria."
                            });
